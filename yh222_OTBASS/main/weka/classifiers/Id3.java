...
public class Id3 
  ...
  private double computeInfoGain(Instances data, Attribute att) 
    ...
    for (int j = 0; j < att.numValues(); j++) {
      if (splitData[j].numInstances() > 0) {
    	//    System.out.println("split data size is "+splitData[j].size());
   ...
   // System.out.println("entryphy for data is "+computeEntropy(data));

   // System.out.println("infoGain for att:"+att.toString()+" is "+infoGain);
  ...
  private double computeEntropy(Instances data) throws Exception {
   ...
   // System.out.println("entropy is "+entropy + Utils.log2(data.numInstances()));
  ...
  //  System.out.println(" @seperate by attribute:"+att);
	...
	private static void printinsts(Instances ins){
		for(Instance i:ins){
